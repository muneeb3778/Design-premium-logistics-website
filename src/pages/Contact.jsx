...
export default function Contact({ onNavigate }) {
  ...
  const inputClass = "w-full px-4 py-3 border border-hairline rounded-sm text-sm font-body text-navy placeholder:text-dim/50 bg-white focus:outline-none focus:border-navy focus:ring-1 focus:ring-navy/20 transition-colors"
  const labelClass = "block text-navy text-xs font-semibold font-display tracking-wide uppercase mb-2"

  return (
    <div>
      {/* Hero */}
      <section className="relative overflow-hidden bg-navy" style={{ minHeight: '44vh', display: 'flex', alignItems: 'flex-end' }}>
        <img
        ...
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(12,37,69,0.94) 0%, rgba(12,37,69,0.6) 60%, rgba(12,37,69,0.15) 100%)' }} />
        <div className="max-w-[1320px] mx-auto px-5 lg:px-10 w-full relative py-14 pt-[110px]">
          <SectionLabel>Contact</SectionLabel>
          <h1 className="text-white text-4xl lg:text-5xl font-bold font-display max-w-xl leading-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-5 mb-8">
                ...
                <div className="flex items-start gap-3.5">
                  <div className="w-9 h-9 bg-linen rounded-sm flex items-center justify-center shrink-0 mt-0.5">
                    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-navy/60" aria-hidden="true">
            ...
            <div>
              ...
              {submitted ? (
                <div className="p-8 bg-linen border border-hairline rounded-sm text-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-navy text-white text-sm font-bold font-display rounded-sm hover:bg-navy-mid transition-colors"
                  >
                    Send Enquiry
                  </button>
                </form>
