    ...
    <footer className="bg-navy border-t border-white/10">
      <div className="max-w-[1320px] mx-auto px-5 lg:px-10">
        ...
        <div className="py-16 lg:py-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.3fr_0.75fr_0.75fr_0.95fr] gap-x-10 gap-y-14 lg:gap-x-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-2.5">
              ...
              >
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-white" aria-hidden="true">
                  <path d="M22 12.061C22 6.505 17.523 2 12 2S2 6.505 2 12.061c0 5.022 3.657 9.184 8.438 9.939v-7.03H7.898v-2.909h2.54V9.845c0-2.522 1.492-3.915 3.777-3.915 1.094 0 2.238.197 2.238.197v2.476h-1.26c-1.243 0-1.631.775-1.631 1.57v1.888h2.777l-.444 2.909h-2.333V22c4.781-.755 8.438-4.917 8.438-9.939z" />
                </svg>
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="mailto:[EMAIL_ADDRESS]" className="flex items-start gap-2.5 text-sm text-white/55 hover:text-white/90 transition-colors font-body group break-all">
                  <svg viewBox="0 0 16 16" className="w-4 h-4 fill-white/35 mt-0.5 shrink-0 group-hover:fill-white/60 transition-colors" aria-hidden="true">
              ...
              <li>
                <a href={waLink} target="_blank" rel="noopener noreferrer" className="flex items-start gap-2.5 text-sm text-white/55 hover:text-white/90 transition-colors font-body group">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white/35 mt-0.5 shrink-0 group-hover:fill-white/60 transition-colors" aria-hidden="true">
              ...
              <li className="flex items-start gap-2.5">
                <svg viewBox="0 0 16 16" className="w-4 h-4 fill-white/35 mt-1 shrink-0" aria-hidden="true">
                  <path d="M8 16s6-5.686 6-10A6 6 0 002 6c0 4.314 6 10 6 10zm0-7a3 3 0 110-6 3 3 0 010 6z" />
                </svg>
                <span className="text-sm text-white/55 font-body leading-relaxed">[Company Address]<br />United Kingdom</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/35 font-body order-2 sm:order-1">
          ...
          <div className="flex flex-wrap items-center gap-4 order-1 sm:order-2">
            {['Privacy Policy', 'Cookie Policy', 'Terms & Conditions', 'Accessibility'].map((link) => (
              <button key={link} className="text-xs text-white/35 hover:text-white/60 transition-colors font-body">
                {link}
              </button>
            ))}
          </div>
