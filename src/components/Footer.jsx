        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              ...
              <li>
                <a href="https://wa.me/[WHATSAPP_NUMBER]" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2.5 text-sm text-white/45 hover:text-white/80 transition-colors font-body group">
